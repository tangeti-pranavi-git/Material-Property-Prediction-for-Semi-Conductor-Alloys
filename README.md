...
Machine Learning Model(Notebook: model_experiments.ipynb):
Machine learning models are trained to predict band gap values.
Model Used : Random Forest Regressor - Random Forest is an ensemble learning method that builds multiple decision trees and averages their predictions.
...
Install required libraries : pip install pandas scikit-learn mp-api jupyter matplotlib seaborn

To Run the Project ,follow the notebooks in this order:
...
Applications :This project can be useful in
Materials discovery
